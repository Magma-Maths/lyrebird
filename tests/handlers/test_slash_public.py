"""Tests for slash_public handler."""

from __future__ import annotations

from unittest.mock import MagicMock

from lyrebird.handlers.slash_public import handle
from tests.conftest import make_private_issue_body


def test_posts_message_to_public(config, mock_client):
    payload = {
        "issue": {
            "number": 10,
        ...
        "comment": {
            "id": 500,
            "body": "/public We're looking into this.",
    ...
    mock_pub_issue.create_comment.assert_called_once_with("**@engineer**:\n\nWe're looking into this.")
...
def test_posts_message_to_public_anonymous(config, mock_client):
    payload = {
        "issue": {
            "number": 10,
            "body": make_private_issue_body(),
        ...
        "comment": {
            "id": 500,
            "body": "/public --anon We're looking into this.",
            "html_url": "https://github.com/testorg/private-repo/issues/10#issuecomment-500",
            "user": {"login": "engineer"},
        },
        "sender": {"login": "engineer", "type": "User"},
